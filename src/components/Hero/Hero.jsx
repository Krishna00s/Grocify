...
const Hero = () => {
    return (
        <section>
            <div className='flex md:flex-row flex-col items-center min-h-screen max-w-350 mx-auto px-10 md:pt-25 pt-35'>
                {/* Hero Content */}
                <div className='flex-1'>
                    ...
                    <p className='text-zinc-600 text-lg max-w-132.5 mt-5 mb-10' >
